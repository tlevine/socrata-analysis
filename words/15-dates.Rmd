...
typically provides a tool for this: the metric of number of datasets. We can go to
...
## The bigger picture
I thought this was going to be an article about a metric for how up-to-date
our data portal data are, but I wound up finding that the data are completely
out-of-date. Given the hype 

Maybe this says something about the need for more metrics of the progress of
