...
---
```{r configure, echo = FALSE, warning = FALSE}
source('15-dates.r')
opts_chunk$set(fig.width=10, fig.height=10, dpi = 42 * 5, echo = FALSE, warning = FALSE)
```
...
```{r dataset_counts_over_time, fig.height = 7}
p18
```
...
```{r updates_2013_hist, fig.height = 5}
p12
```

Here they are by url.

```{r updates_2013_url, fig.height = 5, fig.width = 14}
p13
```
