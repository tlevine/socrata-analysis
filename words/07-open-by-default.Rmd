...
of data, just like when you fill out a form on an open data portal. If you and
others in your organization do this a lot and the dataset doesn't contain private
information, you have already assembled a large dataset that could be open.
...
A program's will be easy to open if it already stores its data on the internet
("software as a service") and it clearly separates public data from private data.

In the longer term, think about how we can make software that encourages that
its data be open by default. I've proposed that clear separations between public
and private data is part of this and that standard storage methods is another,
but there are probably other relevant features.
