...
The various services I just mentioned are great ways of collecting data, but they
tend not to focus on cataloging disparate datasets, converting them to different
formats, &c. Said otherwise, they don't open data. It's not like they're particularly
trying to keep the data closed either; it's probably more that their customers
haven't asked them for open data features.
