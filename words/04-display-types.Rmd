...
it in any number of ways. For a very rough example, we can search Socrata.
...
The calendar was just one of many visualizations of the same dataset.
...
### Day of week
What days of the week are the meetings usually on?
...
But rather than figuring out what's wrong, let's live life on the edge and ignore them.
