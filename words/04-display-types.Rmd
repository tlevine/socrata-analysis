...
*There's also a concept of a `viewType`, which is the underlying representation in of the dataset in Socrata's database. We won't worry about that for now.*
...
## Things that you might not think of as open data
