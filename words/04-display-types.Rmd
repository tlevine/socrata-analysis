...
ggplot(socrata) + aes(x = displayType) + geom_bar() + coord_flip() +
  labs(title = 'Popularity of different visualizations on Socrata data portals') +
  scale_y_discrete('Type of visualization') +
  scale_y_discrete('How many are on the portals')
```
...
I looked through the different visualization types and became quite interested
in calendars.
...
Oregon. Oregon even has one meeting in Washington!
...
(More precisely, most meetings start in the middle of the week and last less than a day.)
