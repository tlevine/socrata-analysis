...
This reminds me of Tim Berners-Lee's
[five stars of open data](http://www.w3.org/DesignIssues/LinkedData.html).
Socrata is currently being used more to move data from private silos
(zero stars) to open formats on the web that machines can read easily
(three stars). The fourth and fifth stars involving implementing
linked-data standards so that we can have this magical data graph.

This five-stars model 
