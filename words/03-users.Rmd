...
```{r roleName.plot}
.t <- table(users$n_tables > users$n_views, users$has.role)
barplot(.t / rowSums(.t), border = NA, 
barplot(a / rowSums(a), col = c('grey', '#dddddd'), border = NA, legend = c('Has roleName', 'No roleName'))
