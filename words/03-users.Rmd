...
```{r n.views}
stripchart(log10(users$n_views), method = 'jitter',
  pch = 21, col = NA, bg = rgb(0,0,0,0.2, max = 1), xlim = c(0,4),
  axes = F, xlab = 'Number of views owned by the user',
  main = 'Each dot is a user'
)
axis(1, at = c(0, 1:4), labels = c(0, 10^(1:4)))
```
