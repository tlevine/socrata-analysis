...
tables than views. I suspect that this means that the original dataset is private
and that some views on that dataset are public. So these might be data publishers.

I looked at the users who had more tables than views.
