...
These charting tools seem really clunky and stupid to me, but I live in this bubble
of people who know how to use computers. [Nicole Neditch](https://twitter.com/nneditch)
explained to me that this is outrageously useful people who aren't strange like me.
She told me of one instance where someone in the Oakland government made a pie chart in
...
I wanted to find people like this, that is, people whose approach to analysis and
reporting changes because of these web-based analysis tools that are strongly integrated
...
But before I do that, I need to get the user data, which involves learning more about
Socrata's API.
...
suspician that people with `roleName` fields are data publishers.
...
If people are analyzing open data in Excel and then disseminnating the findings as
...
analysis publically if only it were easier.
...
software differently if they could easiy collect and analyze data from all of the portals.
...
### We need to study usage more.
I managed to find a few interesting users, but I'm somewhat disappointed.
The available data are quite coarse, few variables are exposed. There's apparently
more in the administrator dashboard, like historical download counts and logs of
when a person accessed a view that was embedded in another website.

But portal administrators have do have access to these data! If you run a portal,
you should be studying this in order to understand what data people are using,
how people are using it and how you can improve your open data offerings. Actually,
even better, you should just release the usage data publically so I can do this for you.
Socrata even has a feature that lets you do that automatically!
...
and document it for you, which might be highly embarassing and/or highly convenient.
