...
My [first post] looked at popular datasets
[second post] looked at big dataset families
now I look at heavy and otherwise interesting users.
...
I could go on with looking at the people associated with the specific points,
but it's sort of annoying with the way I'm making the graph. I could use one of
the interactive graphics R packages, but I think it's easier to make a webby
thing. Maybe some other time.

## Conclusions, lessons, &c.
