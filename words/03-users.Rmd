...
head(citizens[order(citizens$n_views, decreasing = T),columns], 20)
```
...
#### VinylFox
![VinylFox](<%= @item.identifier %>VinylFox.jpg)
...
![Dave Francis Rodrigues](<%= @item.identifier %>Dave Francis Rodrigues.jpg)
