...
```{r configure, echo = F}
opts_chunk$set(fig.width=10, fig.height=5, dpi = 42 * 6)
```
...
```{r dataset_size_by_portal, fig.height = 10}
...
```{r datasets_size_over_time, fig.width = 5}
