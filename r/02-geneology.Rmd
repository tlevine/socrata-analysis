...
## Figuring out the metadata schema
...
Okay, so owner might tell us something about data portal.
...
Many different datasets may descent from one dataset.
...
In such situations, all of the views have the exact same JSON metadata file.
Even the dataset `id` fields are the same.
